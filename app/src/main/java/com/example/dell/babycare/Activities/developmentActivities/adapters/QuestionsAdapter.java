    ...
    public void onBindViewHolder(final MyHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                go.putExtra("question",onlyQuestion.get(position));
                go.putExtra("name",oniyName.get(position));
                go.putExtra("profile",oniyProfile.get(position));
                go.putExtra("position",position);
                go.putExtra("answerkey",onlyKey.get(position));
                go.putExtra("key",accountkey.get(position));
                go.putExtra("date",onlyDate.get(position));
                go.putExtra("time",oniyTime.get(position));
