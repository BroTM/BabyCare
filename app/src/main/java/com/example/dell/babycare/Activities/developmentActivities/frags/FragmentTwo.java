...
public class FragmentTwo extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        List<BegintoThree> blist = BegintoThree.getAllData(BegintoThree.class);
        ...
        FirstRVAdatpter adatpter = new FirstRVAdatpter(getActivity(), namelist,detaillist, childKey,R.drawable.develop);
