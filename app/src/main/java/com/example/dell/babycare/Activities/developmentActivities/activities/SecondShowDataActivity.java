...
public class SecondShowDataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ကေလးေရာဂါမ်ား");
        ...
        FirstRVAdatpter adatpter = new FirstRVAdatpter(SecondShowDataActivity.this,detaillist,namelist,childKey,R.drawable.diseases);
