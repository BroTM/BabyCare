...
import com.example.dell.babycare.Activities.developmentActivities.model.SixtoTenMonth;
...
public class FragmentThree extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        List<BegintoThree> blist = SixtoTenMonth.getAllData(BegintoThree.class,"SixtoTenMonth");
