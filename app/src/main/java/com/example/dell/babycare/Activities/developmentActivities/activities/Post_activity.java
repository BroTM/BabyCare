...
public class Post_activity extends AppCompatActivity implements View.OnClickListener {
                ...
                if (Login_Activity.haveNetworkConnection(Post_activity.this)){
                    ...
                    if (factString.equals("")){
                      ...
                      //  Toast.makeText(this, Date(), Toast.LENGTH_SHORT).show();
                        ...
                        fact.setText("");
                        getImage.setImageResource(R.drawable.gallery);
                        Toast.makeText(this, "တင္ျပီးပါျပီ", Toast.LENGTH_SHORT).show();
                    }
                }
                else
                {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(null ==data){
            Glide.with(this).load(R.drawable.gallery).into(getImage);
