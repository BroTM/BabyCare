...
public class FragmentSeven extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        List<BegintoThree> blist = BegintoThree.getAllData(BegintoThree.class,"FivetoSixYear");
        ...
        adatpter = new FirstRVAdatpter(getActivity(),detaillist,namelist,childKey,R.drawable.develop);
