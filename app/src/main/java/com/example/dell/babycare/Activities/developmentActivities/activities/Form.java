...
Button btnok;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bith= (TextView) findViewById(R.id.birthedit);
        bith.setOnClickListener(this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(null ==data){
            Glide.with(this).load(R.drawable.gallery).into(profile);
    ...
    public void onClick(View view) {
        ...
        {case R.id.profile:
            ...
            case R.id.birthedit:
                ...
                DatePickerDialog startdatePickerDialog=new DatePickerDialog(Form.this, Form.this,startyear,startmonth,startday);
    ...
    public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
        int  startyearFinal=year;
        int  startmonthFinal=month+1;
        int  startdayFinal=dayOfMonth;
        bith.setText(startyearFinal+":"+startmonthFinal+":"+startdayFinal);
    }
}
