...
public class ArticlesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ဆုံးမနည္းမ်ား");
        ...
        recArticle.setHasFixedSize(true);
        recArticle.setLayoutManager(new LinearLayoutManager(ArticlesActivity.this));
       FirstRVAdatpter adatpter = new FirstRVAdatpter(ArticlesActivity.this,detaillist,namelist,childKey,R.drawable.artical);
